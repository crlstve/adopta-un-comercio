            ...
            ?>
                <?php if(wp_is_mobile()): ?>
                    <li class="comercio-item">
                        <div class="w-full grid grid-cols-2">
                             <?php if (has_post_thumbnail() && !has_term('abierto','comercio_categoria', $post)): ?>
                                <?php $featured_image_url = get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>
                                <div class="w-full min-h-64" style="background-image: url('<?php echo esc_url($featured_image_url); ?>'); background-size: cover; background-position: center;">
                                </div>
                             <?php endif; ?>
                             <?php $img_2_id = get_post_meta(get_the_ID(), 'img_2', true);
                                ...
                                ?>
                                <div class="w-full min-h-64" style="background-image: url('<?= esc_url($img_2_url); ?>'); background-size: cover; background-position: center;">
                                </div>
                             <?php endif; ?>
                        </div>
                        ...
                        <details class="bg-dark flex flex-col md:flex-row justify-between">
                            ...
                            <?php else: ?>
                                <div class="bg-pink w-full h-6"> </div>
                            <?php endif; ?>
                ...
                <?php endif; ?>
                        <div class="w-full flex flex-row justify-between">
                                ...
                                <?php else: ?>
                                    <span class="w-full bg-pink text-dark py-3 px-6 text-center">
